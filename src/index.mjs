...
const PRODUCT = {
  "repo": "tableau-dashboard-governance-auditor",
  "vendor": "Tableau",
  "title": "dashboard governance auditor",
  "domain": "BI / Analytics",
  "audience": "Analytics leaders, revenue operations, BI owners, and board-reporting teams",
  "problem": "Dashboards lose trust when certified sources, metric definitions, refresh health, and ownership are unclear.",
  "workflow": "The product checks dashboard ownership, source certification, metric lineage, refresh reliability, and decision readiness.",
  "business": "Leaders can decide which reports can support board narratives and which require remediation before use.",
  "technical": "Synthetic BI lanes are scored by a deterministic CLI and surfaced as a crawlable governance brief.",
  "integration": "Tableau workbooks, data sources, extracts, owner metadata, certification flags, and refresh events.",
  "keywords": [
    "Tableau",
    "BI governance",
    "dashboard trust",
